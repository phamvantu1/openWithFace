...
const char* serverUrl = "http://192.168.85.239:3000/log_access"; // Địa chỉ IP máy chủ

const char* serverUrlpass = "http://192.168.85.239:5000/check_pass"; // Địa chỉ IP máy chủ
const char* serverUrlCheckOTP = "http://192.168.85.239:5000/verify-otp";
const char* sendEmailUrl = "http://192.168.85.239:5000/send-email";
const char* otpServerUrl = "http://192.168.85.239:5000/generate-otp";
